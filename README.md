...
<p align="center">
  <a href="https://github.com/padosoft/laravel-iam-bridge-spatie-permission/actions/workflows/tests.yml"><img src="https://img.shields.io/github/actions/workflow/status/padosoft/laravel-iam-bridge-spatie-permission/tests.yml?branch=main&style=flat-square&label=tests" alt="Tests"></a>
