...
use Padosoft\Iam\Bridge\Spatie\IamSpatieBridgeServiceProvider;
...
{
    /**
     * The bridge is tested together with the server package (its in-process PDP,
     * Grant/Permission models and migrations) and the client package, both resolved
     * from Packagist as dev dependencies.
     *
    ...
    protected function getPackageProviders($app): array
    {
        return [
            ...
            IamSpatieBridgeServiceProvider::class,
        ];
    }
